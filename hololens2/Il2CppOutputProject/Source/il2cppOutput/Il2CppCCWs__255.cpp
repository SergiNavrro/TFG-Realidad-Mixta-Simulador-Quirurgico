...
{
	int32_t ___Level;
	MaterialU5BU5D_t2B1D11C42DB07A4400C0535F92DBB87A2E346D3D* ___CloudMaterials;
	float ___mLevelPointSize;
};
...
{
	int32_t ___id;
	Bounds_t367E830C64BBF235ED8C3B2F8CF6254FDCAD39C3 ___visibilityBounds;
	Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___relativeToRootPosition;
	int32_t ___depth;
	float ___geometricError;
	SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C* ___transform;
	PCBoundingVolume_t112AD6186D5A50F91BE4F7D1896A694F067D9CD9* ___boundingVolume;
	String_t* ___refine;
	PCContentUrl_t1C5AB4ACEBF9A20681A60961A7E06088BFB81C3E* ___content;
	PCTileU5BU5D_tF379F082F5E4F76C891C248A352A5F7160E09057* ___children;
};
...
{
	int32_t ___MAX_HEIGHT_PROPERTY_ID;
	int32_t ___MIN_HEIGHT_PROPERTY_ID;
	int32_t ___sPointSizePropertyID;
	int32_t ___sUseNormalsPropertyID;
	int32_t ___sCenterPropertyID;
	int32_t ___sAxisYPropertyID;
};
